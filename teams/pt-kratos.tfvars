teams = {
  pt-kratos = {
    ...
    github_repositories = {
      "pt-kratos-testing" = {
        description                       = "Testing infrastructure and automation for the Kratos platform team."
        ...
        environments = {
          non-production = {
            ...
            name = "Non-Production"
            reviewers = {
              teams = ["pt-kratos-non-production-approvers"]
            }
          }
          production = {
            deployment_branch_policy = {
            ...
            name = "Production"
            reviewers = {
              teams = ["pt-kratos-production-approvers"]
            }
          }
          sandbox = {
            deployment_branch_policy = {
            ...
            name = "Sandbox"
            reviewers = {
              teams = ["pt-kratos-sandbox-approvers"]
            }
          }
        }
