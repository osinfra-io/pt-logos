teams = {
  et-delete = {
    ...
    github_repositories = {
      "et-delete" = {
        ...
        environments = {
          non-production = {
            ...
            name = "Non-Production"
            reviewers = {
              teams = ["et-delete-non-production-approvers"]
            }
          }
          production = {
            deployment_branch_policy = {
            ...
            name = "Production"
            reviewers = {
              teams = ["et-delete-production-approvers"]
            }
          }
          sandbox = {
            deployment_branch_policy = {
            ...
            name = "Sandbox"
            reviewers = {
              teams = ["et-delete-sandbox-approvers"]
            }
          }
        }
      ...
      "et-delete-docs" = {
        description    = "Documentation for the et-delete enabling team."
